 ...
 * @desc 用于标记战斗中获得多少经验值的文字
 * @default 获得经验
 *
 * @param Gained EXP Format
 * @desc 用于显示战斗中获得多少经验值的文本格式
 * @default +%1
 *
 * @param EXP Gauge Color 1
 * @desc 胜利后续窗口中显示的经验值 gauge 颜色 1 所使用的皮肤颜色
 * @default 30
 *
 * @param EXP Gauge Color 2
 * @desc 胜利后续窗口中显示的经验值 gauge 颜色 2 所使用的皮肤颜色
 * @default 31
 *
 * @param Level Gauge Color 1
 * @desc 如果角色升级，经验值 gauge 颜色 1 所使用的皮肤颜色
 * @default 14
 *
 * @param Level Gauge Color 2
 * @desc 如果角色升级，经验值 gauge 颜色 2 所使用的皮肤颜色
 * @default 6
 *
 * @param Gauge Ticks
 * @desc 这是经验值 gauge 填满之前的跳动次数。每次跳动为 4 帧
 * @default 15
 *
 * @param Tick SE
 * @desc 这将是经验值 gauge 填充时使用的音效
 * @default Absorb2
 *
 * @param Tick Volume
 * @desc 这将是所播放音效的音量
